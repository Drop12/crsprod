...
$status=null;
if (isset($_GET['passwordoneadmin'])) {

    $passwordoneadmin=$_GET['passwordoneadmin'];
    $passwordtwo=$_GET['passwordtwo'];
    
    if($passwordoneadmin==$passwordtwo)
    {
        $password=sha1($passwordtwo);
        $user_id=$_SESSION['user_id'];
        $sql_update="UPDATE tbl_credentials SET `password`='$password' where `user_id`='$user_id'";
                                ...
                                <div class="card-body p-5">
                                    ...
                                    <form class="row g-3" action="changepassword.php" method="GET">
                                        ...
                                        <div class="col-md-12">
                                            ...
                                            <input type="password" class="form-control" id="passwordtwo" name="passwordtwo" placeholder="xxxxxxxxxxxx" required>
                                        </div>
                                        <div class="col-12 text-center">
                                            <button type="submit" class="btn btn-primary px-5" style="background-color: #374F99;">Save</button>
                                        </div>
                                    </form>
                                </div>
                            </div>
