...
{    
    $c_id = mysqli_real_escape_string($db,$_GET['insertcallregistry']);
    $category = mysqli_real_escape_string($db,$_GET['category']);
    $sql = "UPDATE  tbl_registryinput SET `category_r`='$category',`status_r`='Assigned' where `id`='$c_id'";
    mysqli_query($db, $sql);
}
                        ...
                        <div class="card-body">
                            ...
                            <table id="example" class="display" cellspacing="0" width="100%">
                                ...
                                <tbody>
                                    <?php
                                  $x = 1;
                                  $sql_gete = "SELECT * FROM   tbl_registryinput where `status_r`='reassigned' ORDER  by reg_date desc";
                                  ...
                                  <td align="center" style="width: 20px;"><?php echo $row['ticket_id']; ?></td>
                                      ...
                                      <td align="center"><?php echo capitalizeFirstLetter($row['status_r']); ?></td>
