...
elseif(isset($_GET['updateprod']))
{
    $c_id = mysqli_real_escape_string($db,$_GET['updateprod']);
    $nmessage = mysqli_real_escape_string($db,$_GET['nmessage']);
    $sql = "UPDATE tbl_call_registry SET `ttext`='$nmessage',`is_transcribed`='1' where `id`='$c_id'";
    mysqli_query($db, $sql);
...
<!-- DataTable with Buttons -->
            ...
            <div class="row">
                <div class="col-sm-12">
                    <div class="card">
                        <div class="card-body">
                            <h4 class="m-t-0 header-title">Calls Received</h4>
                            ...
                            <table id="example" class="display" cellspacing="0" width="100%">
                                <thead>
                                    <tr>
                                        ...
                                        <td align="center">Download File/Listen</td>
                                ...
                                <tbody>
                                    <?php
                                  $x = 1;
                                  $sql_gete = "SELECT * FROM   tbl_call_registry where `filelocd`<>'' and `is_transcribed`='0' order by reg_date desc";
                                  ...
                                  <tr>
                                      ...
                                      <td align="center" style="width: 50px;"><?php echo get_cdr_region($row['mkoa']); ?></td>
                                      <td align="center" style="width: 50px;"><?php echo get_crd_swali_lipi($row['swali_lipi']); ?></td>
