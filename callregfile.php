...
if(isset($_GET['recid']))
{
    $reg_iddddd=$_GET['recid'];
    $sql_gete = "SELECT * FROM   tbl_registryinput where `id`='$reg_iddddd' order by reg_date desc";
  $result_set = mysqli_query($db, $sql_gete);
  while ($row = mysqli_fetch_array($result_set, MYSQLI_ASSOC)) {
      $phone_number=$row['phone_number'];
      $text=$row['regdetails'];
      $statuscall=$row['status_r'];
...
{
    $reg_iddddd=$_GET['updatestatus'];
    $status=$_GET['status'];


    $update_sql="UPDATE tbl_registryinput SET `status_r`='$status' where `id`='$reg_iddddd'";
                ...
                <div class="col-lg-6">
                    <div class="card">
                        <h5 class="card-header text-center"
                            style="background-color:#38a4f8;color:#ffffff;font-size:15px;">
                            Details</h5>
                            <div class="card-body">
                            <table id="datatable" class="table table-bordered dt-responsive nowrap"
                                ...
                                <tr>
                                    <td>Status</td>
                                    <td><?php echo capitalizeFirstLetter($statuscall);?></td>
                                </tr>
                                <tr>
                                    <td>Details</td>
                                    <td><?php echo $text;?></td>
                                ...
                                <div class="modal-content">
                                    <div class="modal-header text-center">
                                        <h5 class="modal-title text-center"
                                            style="color:#0D73BB">Kindly Fill The Below Details</h5>
                                    ...
                                    <div class="modal-body">
                                        ...
                                        <div class="col-md-12" hidden>
                                                <label for="inputLastName"
                                                    ...
                                                    id="inputLastName" name="insertscriptfllup"
                                                    value="<?php echo $reg_iddddd; ?>" readonly>
                                            </div>
                                            <br/>
                                            <div class="form-group row" style="margin-top:14px;">
                                            <label class="col-2 col-form-label">Select Status</label>
                                            <div class="col-10">
                                                <select class="form-control show-tick" name="ftitle" required
                                                    ...
                                                    <option value="reassigned">Assign Back
                                                    </option>
                                                </select>
                                            </div>
                                        </div>
                                            <div class="form-group row" style="margin-top:14px;">
                                                <label class="col-2 col-form-label" for="example-email">Details</label>
                                                <div class="col-10">
...
<!-- DataTable with Buttons -->
            ...
            <div class="row">
                <div class="col-sm-12">
                    <div class="card">
                        <div class="card-body">
                            <h4 class="m-t-0 header-title">Follow-up updates</h4>
                               ...
                               <thead>
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td align="center" style="width: 50px;"><?php echo capitalizeFirstLetter($row['rtitle']); ?></td>
                                        <td align="center" style="width: 50px;"><?php echo $row['tdetails']; ?></td>
                                    </tr>
                                    <?php 
                                        $x++;
                                    } 
