                            ...
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <form action="insertscript" method="GET">
                                        <div class="row clearfix">
                                            ...
                                            <div class="col-lg-10 col-md-10 col-sm-8 col-xs-7">
                                                <div class="form-group">
                                                    <div class="form-line">
                                                        <input type="text" name="insertcredetials"
                                        ...
                                        <div class="row clearfix">
                                            <div class="col-lg-2 col-md-2 col-sm-4 col-xs-5 form-control-label">
                                                <label for="branchname">E-mail:</label>
                                            </div>
                                            <div class="col-lg-10 col-md-10 col-sm-8 col-xs-7">
                                                <div class="form-group">
                                                    <div class="form-line">
                                                        <input type="email" name="idnumber"
                                                            class="form-control" required>
                                                    </div>
                                                </div>
                                            </div>
                                        ...
                                        <div class="form-group row" style="margin-top:14px;">
                                            ...
                                            <div class="col-10">
                                                 <select class="form-control show-tick" name="usertype" required
                                                            ...
                                                            <option value="crsadmin">Administrator</option>
                                                            <!--<option value="crsofficer">Program Officer</option>-->
                                                        </select>
                                            </div>
                                        </div>
                                        <br />
                                        <h4 class="text-center">
                                            <input type="submit" class="btn btn-primary btn-sm" value="Save" style="background-color: #4CAF50; /* Green background */
            color: white;"
...
<!-- DataTable with Buttons -->
            ...
            <div class="row">
                <div class="col-sm-12">
                    <div class="card">
                        <div class="card-body">
                            <h4 class="m-t-0 header-title">Registered Users</h4>
                            ...
                            <table id="example" class="display" cellspacing="0" width="100%">
                                ...
                                <tbody>
                                    <?php
                                    $x = 1;
                                    $sql_gete = "SELECT * FROM  tbl_credentials   order by reg_date desc";
