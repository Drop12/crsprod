...
<!-- DataTable with Buttons -->
            ...
            <div class="row">
                <div class="col-sm-12">
                    <div class="card">
                        <div class="card-body">
                            <h4 class="m-t-0 header-title">Registered Regions</h4>
                            ...
                            <table id="example" class="display" cellspacing="0" width="100%">
                                ...
                                <tbody>
                                    <?php
                                    $x = 1;
                                    $sql_gete = "SELECT * FROM   tbl_region2 where `iss_used`='1' order by region_name asc";
                                    ...
                                    <tr>
                                        ...
                                        <td align="center" style="width: 50px;"><?php echo $row['region_name']; ?></td>
                                        <td align="center" style="width: 50px;"><?php echo $row['reg_date']; ?></td>
                                        <td align="center" style="width: 50px;"><a href="locfile?reg_id=<?php echo $row['region_id']; ?>" class="btn btn-primary"><?php echo 'Open File'; ?></a></td>
                                    </tr>
                                    <?php 
                                        $x++;
                                    } 
