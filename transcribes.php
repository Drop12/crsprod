...
if (isset($_GET['c_id'])) {
    ...
    $sql = "SELECT filelocd from tbl_call_registry where `id`='$c_id'";
...
.glow-new-entry {
    ...
    border-radius: 4px; /* Optional: to round corners */
}
    </style>
                            ...
                            <table id="example" class="display" cellspacing="0" width="100%">
                                <thead>
                                    <tr>
                                        ...
                                        <td align="center">Ward/Village</td>
                                ...
                                <tbody>
                                  ...
                                  if($_SESSION['userrole']=="crsadmin")
                                {
                                  if(isset($_GET['startdaterr']))
                                    {
                                        $startdate=$_GET['startdaterr'];
                                        $enddate=$_GET['enddate'];
                                        $sql_gete = "SELECT * FROM   tbl_registryinput where  `reg_date` BETWEEN '$startdate' AND '$enddate' ORDER  by reg_date desc";
                                    }
                                    elseif(isset($_GET['projectfl']))
                                    {
                                        $projectfl=$_GET['projectfl'];
                                        $sql_gete = "SELECT * FROM   tbl_registryinput  order by reg_date desc";
                                    }
                                    else
                                    {
                                       $sql_gete = "SELECT * FROM   tbl_registryinput  order by reg_date desc";
                                ...
                                else
                                {
                                  ...
                                  ?>
                                  <tr>
                                      <td align="center" style="width: 20px;"><?php echo $row['ticket_id']; ?></td>
                                      ...
                                      <td align="center" style="width: 50px;"><?php echo get_cdr_regionr($db,$row['region']); ?></td>
                                        <td align="center" style="width: 50px;"><?php echo get_cdr_districtr($db,$row['district']); ?></td>
                                      <td align="center" style="width: 50px;"><?php echo $row['ward_village']; ?></td>
                                      ...
                                      <td align="center" class="<?php echo ($row['status_r']== 'assigned') ? 'glow-new-entry' : ''; ?>">
