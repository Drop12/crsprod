...
if(isset($_GET['reg_id']))
{
    ...
    $sql_update="UPDATE tbl_credentials SET `status`='$update' where `user_id`='$reg_id'";
                    ...
                    <div class="card">
                        <h5 class="card-header text-center"
                            ...
                            <table id="datatable" class="table table-bordered dt-responsive nowrap"
                                ...
                                <tr>
                                    <td>Region Name</td>
                                    <td><?php echo get_regionnamennn($db,$reg_id);?></td>
                                </tr>
                            </table>
                        </div>
                    </div>
...
<!-- DataTable with Buttons -->
            ...
            <div class="row">
                <div class="col-sm-12">
                    <div class="card">
                        <div class="card-body">
                            <h4 class="m-t-0 header-title">Registered Disrticts</h4>
                            ...
                            <table id="example" class="display" cellspacing="0" width="100%">
                               <thead>
                                ...
                                <tbody>
                                    <?php
                                    $x = 1;
                                    $sql_gete = "SELECT * FROM    tbl_district2 where region_id='$reg_id' order by district_name asc";
                                    ...
                                    <tr>
                                        ...
                                        <td align="center" style="width: 50px;"><?php echo $row['district_name']; ?></td>
                                        <!--<td align="center" style="width: 50px;"><a href="locfiled?reg_id=<?php echo $row['district_id']; ?>" class="btn btn-primary btn-xs"><?php echo 'Open File'; ?></a></td>
